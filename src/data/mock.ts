...
export const ASSIGNMENTS: Record<string, Assignment> = {
  ...
  'global-appeals': {
    ...
    numericId: '2305171',
    status: 'pending',
    queueName: 'Denylist Appeals: Rise Scam',
    ...
    denylistInfo: {
      reason: 'Rise Scam',
      reasonCode: 'RISE_SCAM_DENYLIST_L1',
    ...
    assets: [
      {
        ...
        history: [
          ...
          { date: 'Aug 14, 2025 at 2:30:59 PM', action: 'Flagged', actor: 'alert-broker', note: 'Associated with Rise Scam detection rule RT-4821.' },
        ],
      },
      {
        id: 'asset-2',
      ...
      },
      {
        ...
        history: [
          ...
          { date: 'Aug 14, 2025 at 2:31:02 PM', action: 'Flagged', actor: 'alert-broker', note: 'Cashtag included in Rise Scam case cluster.' },
        ],
      },
      {
        id: 'asset-4',
        ...
        history: [
          ...
          { date: 'Aug 14, 2025 at 2:31:07 PM', action: 'Denylisted', actor: 'Risk Ops — Automated', note: 'SSN matched to Rise Scam network. Reason: RISE_SCAM_DENYLIST_L1.' },
        ],
      },
      {
        id: 'asset-5',
    ...
    adversityHistory: [
      {
        ...
        reasons: ['Rise Scam — account-level sweep'],
        reasonCodes: ['RISE_SCAM_DENYLIST_L1'],
      },
      {
        id: 'adv-2',
        issuedBy: 'Risk Ops',
        ...
        type: 'DENYLIST',
        organization: 'AUTOMATED',
        reasons: ['Rise Scam — identity / SSN ending 6892'],
        reasonCodes: ['RISE_SCAM_DENYLIST_L1'],
      },
    ],
  },
